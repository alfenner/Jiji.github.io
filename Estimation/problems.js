...
const MC_GAME_P1  = {
  num: 7,
  den: 11,
  multichoice: [[3,11],[1,5],[7,11],[10,12]],
}
const MC_GAME_P2  = {
  num: 3,
  den: 12,
  multichoice: [[3,12],[7,8],[8,11],[9,11]],
}
const MC_GAME_P3  = {
  num: 5,
  den: 7,
  multichoice: [[1,7],[1,8],[4,10],[5,7]],
}
const MC_GAME_P4  = {
  num: 2,
  den: 5,
  multichoice: [[8,11],[2,5],[7,12],[4,5]],
}
const MC_GAME_P5 = {
  num: 5,
  den: 9,
...
const WARM_UP = {
  prompt: "Record your answers \n on the sheet provided",
  discussion: null,
  problems: [SET_ONE_P1,SET_ONE_P2,SET_ONE_P3,SET_ONE_P4,SET_ONE_P5]
}
...
const MC_GAME = {
  ...
  discussion: null,
  problems: [MC_GAME_P1,MC_GAME_P2,MC_GAME_P3,MC_GAME_P4,MC_GAME_P5]
}
